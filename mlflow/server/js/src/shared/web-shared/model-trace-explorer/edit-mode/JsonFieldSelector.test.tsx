...
describe('JsonFieldSelector', () => {
  it('renders top-level keys as checkboxes', () => {
    ...
    render(<JsonFieldSelector data={data} selectedPath={null} onPathChange={jest.fn()} label="Input Fields" />, {
      wrapper,
    });
  ...
  it('clicking a leaf checkbox calls onPathChange with JSONPath', async () => {
    ...
    render(<JsonFieldSelector data={data} selectedPath={null} onPathChange={onPathChange} label="Input Fields" />, {
      wrapper,
    });
  ...
  it('renders arrays with index notation', async () => {
    ...
    render(<JsonFieldSelector data={data} selectedPath={null} onPathChange={jest.fn()} label="Output Fields" />, {
      wrapper,
    });
  ...
  it('pre-checks field matching selectedPath', () => {
    const data = { query: 'hello', context: 'world' };
    render(<JsonFieldSelector data={data} selectedPath="$.query" onPathChange={jest.fn()} label="Input Fields" />, {
      wrapper,
    });
