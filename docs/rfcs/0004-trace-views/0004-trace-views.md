...
mlflow_issue: https://github.com/mlflow/mlflow/issues/22499
rfc_pr:
---

| Field | Value |
|---|---|
| Author(s) | Forrest Murray |
| Date Last Modified | 2026-05-11 |
| AI Assistant(s) | Claude Code (Anthropic) |
...
![Default state](images/01-default-state.png)
...
![View selector open](images/02-view-selector-open.png)
